<?php
    /*
    	...
    	********************************************************************************************
    */
    // expéditeur du dormulaire. Pour des raisons de sécurité, de plus en plus d'hébergeurs imposent que ce soit une adresse sur votre hébergement/namede domaine.
    ...
    $email_expediteur = 'azerouto@gmail.com';
    $nom_expediteur = 'azerouto@gmail.com';
    ...
    $destinataire = 'azerouto@gmail.com';
    ...
    */
    ...
    else
    {
    	...
    	if (($name!= '') && ($email != '') && ($subject != '') && ($message != ''))
    	{
    		...
    		$subject = str_replace($caracteres_speciaux, $caracteres_remplacement, $subject);
