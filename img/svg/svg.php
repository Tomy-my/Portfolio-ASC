<svg class="reset" width="50" height="50" viewPort="0 0 196 70" version="1.1" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="wrapper">
        <svg class="button-container" viewBox="0 0 100 100" version="1.1" height="100" xmlns="http://www.w3.org/2000/svg">
              <circle class="circle" transform='rotate(270 50 50)' class="button" cx="50" cy="50" r="40" stroke="#38465e" stroke-width="3.9" fill="#fbfbfb" />
              <circle class="circle-inner" transform='rotate(270 50 50)' class="button" cx="50" cy="50" r="38.7" stroke="#38465e" stroke-width="0" fill="#fbfbfb" />
